...
export function saveReport() {
    return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 365 88"><defs><style></style></defs><title>savereport</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><rect className="savereport-1" x="0.5" y="0.5" width="364" height="87" rx="10.92" /><text className="savereport-2" transform="translate(39.79 59.5)">S<tspan className="savereport-3" x="31.81" y="0">a</tspan><tspan className="savereport-4" x="59.5" y="0">v</tspan><tspan className="savereport-5" x="85.76" y="0">e Repo</tspan><tspan className="savereport-6" x="248.22" y="0">r</tspan><tspan x="269.2" y="0">t</tspan></text></g></g></svg>)
}
